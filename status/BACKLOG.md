...
| 15 | backend   | 0 | ready   | — | Gate the Railway deploy on backend tests |
| 16 | backend   | 0 | ready   | — | Fix read auth (`requireAnyToken`) + `GET /api/config` |
...
| 19 | backend   | 1 | blocked | 11 | Migration 007 + images/media libs + `routes/photos.js` |
