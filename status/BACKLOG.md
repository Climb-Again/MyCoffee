...
| 47 | ios-ux    | 6 | ready | 45, 46 | **What's New screen** (PLAN.md §13). Reached from Settings; segmented **Live / Plan** control — Live = feature cards (title + detail + area chip); Plan = pinned **"Needs your approval"** then a section per lane. Read-only v1. `Features/` |
