# ios-shell — archived history

Moved out of `status/ios-shell.md` on 2026-08-28 (backlog #92) so a lane session
reads a small file. Nothing is edited or deleted here — sections are verbatim
and in their original order. Live claims stay in `status/ios-shell.md`; the
