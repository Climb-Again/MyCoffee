...
## Archived Done log (2026-07-29 → 2026-08-15)

Moved to `status/archive/backend-2026-08.md` on 2026-08-29 (backlog #92) — the
legacy bullet-log tail that predates the per-session header format used above,
mostly duplicated by header entries earlier in this file for the same dates.
